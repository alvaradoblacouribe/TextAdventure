...
if left_right == "left" or left_right=="Left":
    ...
    if office_hall == "office" or office_hall=="Office":
        #Left-> Office
        ...
        if files_desktop == "files" or files_desktop=="Files":
            #Left->Office->Files
        ...
        elif files_desktop == "desktop" or filed_desktop == "Desktop":
            #Left->Office->Desktop
    ...
    elif office_hall == "hall" or office_hall=="Hall":
        #Left-> hall
...
if left_right == "right" or left_right=="Right":
    ...
    if storage_party == "party" or storage_party=="Party":
        #Right->Party Room
        print("You chose the Party Room")
    elif storage_party == "store" or storage_party=="Store":
        #Right-> Store
